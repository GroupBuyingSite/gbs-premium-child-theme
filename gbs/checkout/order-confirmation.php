<table class="review_table gb_table">
	<thead>
		<tr>
			<th class="heading_info gb_ff" scope="col" colspan="2"><?php gb_e('Your Order Summary'); ?></th>
			<th class="heading_info gb_ff" scope="col" colspan="1"><?php gb_e('Quantity'); ?></th>
			<th class="heading_info gb_ff" scope="col" colspan="1"><?php gb_e('Price'); ?></th>
		</tr>
	</thead>
	<tfoot>
		<?php if ( $shipping > 0 ): ?>
										...
										<tr>
												...
												<td class="va-middle">
													...
													<?php elseif ( gb_is_voucher_active( $voucher_id ) ): ?>
														<a href="<?php gb_voucher_permalink( $voucher_id, TRUE ) ?>" title="<?php gb_e( 'Download Voucher' ) ?>" class="alt_button voucher_download"><?php gb_e( 'Download' ) ?></a>
													<?php else: ?>
														<span class="clearfix">
															<span class="button"><?php gb_e('Pending') ?></span>
														</span>
													<?php endif ?>
												</td>
												<td class="td_expires">
